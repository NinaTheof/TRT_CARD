Public Class Form4th

    Dim rs As New FormResizer
    Private Sub Form4thForm4th_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        rs.FindAllControls(Me)
        Form3d.Close()
    End Sub
    Private Sub Form4th_Resize(sender As Object, e As EventArgs) Handles Me.Resize
    ...
    Private Sub Form4th_Load(sender As Object, e As EventArgs) Handles MyBase.Load

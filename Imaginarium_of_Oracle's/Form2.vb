Public Class Form2nd
    Dim rs As New FormResizer
    Private Sub Form2nd_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        rs.FindAllControls(Me)
        Form1st.Close()
    End Sub
    Private Sub Form2nd_Resize(sender As Object, e As EventArgs) Handles Me.Resize
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        My.Forms.Form3d.Text = Now.ToString
        My.Forms.Form3d.Show()
    End Sub
End Class